...
public class JupiterAssertionsTests {
    ...
    /* Junit5(Jupiter)에서 제공하는 Assertion 메소드에 대해 이해 할 수 있다.*/
    /* 필기
    *   Junit Jupiter는 JUnit4로부터 온 assertion 메소드와 새롭게 java8 람다 표현식으로 추가된 메소드를 제공한다.
...
//        Assertions.assertEquals(expected, result, "실패할 때 보여줄 메시지");
    ...
    void testAssertNotEqualsWithInstances(){
        ...
        //then
        /* 단, equals와 hashcode가 오버라이딩 되어 있는 경우는 같다고 판단함 */
    ...
    void testAssertAll(){
        ...
        //then
        Assertions.assertAll("그룹화된 테스트의 이름(테스트 실패시 보여짐)",
